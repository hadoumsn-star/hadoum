...
export class StaffController {
  ...
  uploadStaffCv(@Param('id') id: string, @UploadedFile() file: Express.Multer.File) {
    return this.staffService.uploadStaffCv(id, file);
  }

  @Post(':id/schedule')
  @UseInterceptors(FileInterceptor('file', { limits: { fileSize: 10 * 1024 * 1024 } }))
  uploadStaffSchedule(@Param('id') id: string, @UploadedFile() file: Express.Multer.File) {
    return this.staffService.uploadStaffSchedule(id, file);
  }

  @Post(':id/docs')
  @UseInterceptors(FileInterceptor('file', { limits: { fileSize: 10 * 1024 * 1024 } }))
  uploadStaffDoc(@Param('id') id: string, @UploadedFile() file: Express.Multer.File, @Body('label') label: string) {
  ...
  @UseInterceptors(FileInterceptor('file', { limits: { fileSize: 10 * 1024 * 1024 } }))
  uploadCandidateDoc(@Param('id') id: string, @UploadedFile() file: Express.Multer.File, @Body('label') label: string) {
  ...
  promote(@Param('id') id: string, @Body() body: { role?: string; since?: string }) {
  ...
  @Post(':id/attendance')
  @UseInterceptors(FileInterceptor('justif', { limits: { fileSize: 10 * 1024 * 1024 } }))
  createAttendance(
    @Param('id') id: string,
    @Body() body: { type: string; motif?: string; dateDebut: string; dateFin?: string; justified?: string },
  ...
  updateAttendance(@Param('recordId') recordId: string, @Body() body: {
    type?: string; motif?: string; dateDebut?: string; dateFin?: string | null;
  ...
  @UseInterceptors(FileInterceptor('file', { limits: { fileSize: 10 * 1024 * 1024 } }))
  uploadAttendanceJustif(@Param('recordId') recordId: string, @UploadedFile() file: Express.Multer.File) {
  ...
  @Get(':id')
  findOne(@Param('id') id: string) { return this.staffService.findOneStaff(id); }
}
